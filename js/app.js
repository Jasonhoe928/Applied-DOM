(function(window) {
   ...
   */
   ...
   let getButton1 = document.getElementById('btn1');
   getButton1.addEventListener('click', setMyLightGreen)
   ...
   */
   ...
   let getButton2 = document.getElementById('btn2');
   getButton2.addEventListener('click', setMyLightClass)
